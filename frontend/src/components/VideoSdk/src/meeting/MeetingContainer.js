...
export function MeetingContainer({
  ...
  function onEntryResponded(participantId, name) {
    // Check if the local participant ID matches the incoming participant ID
    const isLocalParticipant = mMeetingRef.current?.localParticipant?.id === participantId;
  // console.log(mMeetingRef.current)
    // Check if the local participant is already in the meeting
    // const isAlreadyJoined = mMeetingRef.current?.participants.find(participant => participant.id === participantId);
