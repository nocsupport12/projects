...
export const JobOrderForm = ({
  ...
  useEffect(() => {
    ...
    if (allUsers?.length) {
      const userInCharge = allUsers.find((el) => el._id === user).fullname;
      setCurrentUser(userInCharge);
    }
  }, [updateJobOrder, allUsers]);
            ...
            {natureJobOrder === "application" && (
              <>
                ...
                >
                  {/* CLIENT NAME */}
                  <FormControl
                    pb={{ base: "5", sm: "3", md: "3", lg: "2" }}
                    w={{ base: "100%", sm: "100%", md: "49%", lg: "32%" }}
                  >
                  ...
                  <FormControl>
                    ...
                    <InputGroup>
                      <Input
                        ...
                        onChange={(e) =>
                          setMaterialsNeededInput(e.target.value)
                        }
                        borderColor="blue.300"
                        _hover={{
